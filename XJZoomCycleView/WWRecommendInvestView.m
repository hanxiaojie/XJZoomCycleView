...
#import "WWRecommendInvestView.h"
#import "WWRecommendInvestItemView.h"

@interface WWRecommendInvestView () <UIScrollViewDelegate>{
...
@implementation WWRecommendInvestView
...
- (WWRecommendInvestItemView *)middleItemView{
    if (!_middleItemView) {
        ...
        _middleItemView.layer.shadowColor = WWColorE.CGColor;
        _middleItemView.layer.shadowOffset = CGSizeMake(10, 10);
        _middleItemView.layer.shadowRadius = 4;
        _middleItemView.clipsToBounds = NO;
    }
