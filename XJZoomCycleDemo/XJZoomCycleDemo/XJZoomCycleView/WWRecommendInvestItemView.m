...
- (UILabel *)tipsLabel{
    if (!_tipsLabel) {
        ...
        _tipsLabel.textColor = MainColor;
...
- (UILabel *)investTimeLabel{
    if (!_investTimeLabel) {
        ...
        _investTimeLabel.textColor = MainColor;
...
- (UILabel *)remainAmountLabel{
    if (!_remainAmountLabel) {
        ...
        _remainAmountLabel.textColor = MainColor;
...
- (UILabel *)processLabel{
    if (!_processLabel) {
        ...
        _processLabel.textColor = MainColor;
...
- (UILabel *)joinTitleLabel{
    if (!_joinTitleLabel) {
        ...
        _joinTitleLabel.textColor = MainColor;
...
- (UILabel *)joinDetailLabel{
    if (!_joinDetailLabel) {
        ...
        _joinDetailLabel.textColor = MainColor;
